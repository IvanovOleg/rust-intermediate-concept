...
fn main() {
    ...
    // gets closed. A Receiver channel is automatically closed once all Sender channels have 1
    ...
    for item in vec!["ducks", "bunnies", "dogs"] {
